            ...
            <div class="hoadon__row content-row">
                ...
                <div class="title--border">
                    <div class="hoadon__title row">
                        ...
                        <h6 class="center hoadon-item-title col-4">Địa chỉ</h6>
                ...
                <div class="hoadon--show row">
                    ...
                    if (isset($_SESSION['get']['HoaDon'])) {
                        ...
                        $length = count($HoaDon);
//<span class="hidden row-' . $HoaDon[$i]['maHD'] . ' maNV">' . $HoaDon[$i]['nhanVien']['maNV'] . '</span>                                <span class="center-left col-1">' . $HoaDon[$i]['nhanVien']['ho'] . ' ' . $HoaDon[$i]['nhanVien']['ten'] . '</span>
                        for ($i = 0; $i < $length; $i++) {
                            echo '
                                <div class="checkbox col-1 ">
                                ...
                                <span class="center-left col-4 row-' . $HoaDon[$i]['maHD'] . ' diaChi">' . $HoaDon[$i]['diaChi'] . '</span>
