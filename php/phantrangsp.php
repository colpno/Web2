...
if (count($spArr)<1) {
    ...
    foreach ($spArr as $key=>$value) {
        if ($value['soLuong']>0) {
            echo "<a href='index.php?content=chitietsanpham&maSP=".$value['maSP']."' target='_blank' class='col-xl-4 col-lg-6 col-md-12 col-sm-6'>";
        }
        else {
        ...
        echo "  <div class='product-item mb-4'>
                    <div class='product-item__img' style='background-image:url(".".".substr($value['anhDaiDien'],5).");'></div>
