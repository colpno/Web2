...
if (sl < 1) { sl=1; } document.getElementsByClassName('cart-list-input__text')[0].value=sl; } function nextNumber(x) { var sl=Number(document.getElementsByClassName('cart-list-input__text')[0].value); if (sl < x) { sl +=1; } document.getElementsByClassName('cart-list-input__text')[0].value=sl; } function prevNumberCart(vt,x,masp) { var namesl="slNumberCart" +vt; var sl=Number(document.getElementById(namesl).value); if (sl> 1) {
    ...
    if (sl < 1) { sl=1; } var tongtiensp=Number(document.getElementById('tongtiensp').innerHTML); var thanhtiensp=Number(document.getElementById('thanhtiensp').innerHTML); document.getElementById(namesl).value=sl; document.getElementById('tongtiensp').innerHTML=tongtiensp-tiensp+sl*dongiasp; document.getElementById('thanhtiensp').innerHTML=thanhtiensp-tiensp+sl*dongiasp; document.getElementById(nametsp).innerHTML=sl*dongiasp; $.post("./php/soluongsp.php",{inputsp:masp,slbd:slbd,sl:sl},function(data) { document.getElementsByClassName('cart-list-input__prev')[vt] .setAttribute("onclick","prevNumberCart("+vt+","+(x+slbd-sl)+","+masp+")"); document.getElementById(namesl).setAttribute("onchange","inputnumbercart("+vt+","+(x+slbd-sl)+","+masp+")"); document.getElementsByClassName('cart-list-input__next')[vt] .setAttribute("onclick","nextNumberCart("+vt+","+(x+slbd-sl)+","+masp+")"); }); } function nextNumberCart(vt,x,masp) { var namesl="slNumberCart" +vt; var sl=Number(document.getElementById(namesl).value); if (x>0) {
        var namedg="dongiasp"+vt;
        var nametsp="tiensp"+vt;
        var dongiasp=Number(document.getElementById(namedg).innerHTML);
        var tiensp=Number(document.getElementById(nametsp).innerHTML);
