...
<div class="doi-tac container">
            ...
            <div class="nhacungcap__row content-row">
                ...
                <div class="title--border">
                    <div class="nhacungcap__title row">
                        <div class="center checkbox nhacungcap-item-title col-lg-1">
                        ...
                        <h6 class="center nhacungcap-item-title col-lg-3">Tên nhà cung cấp</h6>
                        <h6 class="center nhacungcap-item-title col-lg-4">Địa chỉ</h6>
                        <h6 class="center nhacungcap-item-title col-lg-2">Số điện thoại</h6>
                        <h6 class="center nhacungcap-item-title col-lg-2">Thao tác</h6>
                    </div>
                </div>
                    ...
                    if (isset($_SESSION['get']['NhaCungCap'])) {
                        ...
                        for ($i = 0; $i < $length; $i++) {
                            echo '
                                ...
                                <span class="center-left col-lg-3 col-md-4 col-sm-12 row-' . $NhaCungCap[$i]['maNCC'] . ' tenNCC">' . $NhaCungCap[$i]['tenNCC'] . '</span>
                                <span class="center-left col-lg-4 col-md-1 col-sm-12 row-' . $NhaCungCap[$i]['maNCC'] . ' diaChi">' . $NhaCungCap[$i]['diaChi'] . '</span>
                                <span class="center col-lg-2 col-md-2 col-sm-12 row-' . $NhaCungCap[$i]['maNCC'] . ' soDienThoai">' . $NhaCungCap[$i]['soDienThoai'] . '</span>
                ...
                <div class="content-item__pagination row">
                    <div>
                        <ul class="text-center center paginate">
                            <li class="nhacungcap-first"></li>
                            <li class="nhacungcap-prev"></li>
                            <?php
                            if (isset($_SESSION['get']['NhaCungCap'])) {
                            ...
                            ?>
                            <li class="nhacungcap-next"></li>
                            <li class="nhacungcap-last"></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="nhasanxuat__row content-row">
                ...
                <div class="title--border">
                    <div class="nhasanxuat__title row">
                        <div class="center nhasanxuat-item-title checkbox col-lg-1">
                        ...
                        <h6 class="center nhasanxuat-item-title col-lg-3">Tên nhà sản xuất</h6>
                        <h6 class="center nhasanxuat-item-title col-lg-4">Địa chỉ</h6>
                        <h6 class="center nhasanxuat-item-title col-lg-2">Số điện thoại</h6>
                        <h6 class="center nhasanxuat-item-title col-lg-2">Thao tác</h6>
                    </div>
                </div>
                    ...
                    if (isset($_SESSION['get']['NhaSanXuat'])) {
                        ...
                        for ($i = 0; $i < $length; $i++) {
                            echo '
                                ...
                                <span class="center-left col-lg-3 col-md-4 col-sm-12 row-' . $NhaSanXuat[$i]['maNSX'] . ' tenNSX">' . $NhaSanXuat[$i]['tenNSX'] . '</span>
                                <span class="center-left col-lg-4 col-md-4 col-sm-12 row-' . $NhaSanXuat[$i]['maNSX'] . ' diaChi">' . $NhaSanXuat[$i]['diaChi'] . '</span>
                                <span class="center col-lg-2 col-md-4 col-sm-12 row-' . $NhaSanXuat[$i]['maNSX'] . ' soDienThoai">' . $NhaSanXuat[$i]['soDienThoai'] . '</span>
                                <div class="center col-lg-2 col-md-3 col-sm-12">
                ...
                <div class="content-item__pagination row">
                    <div>
                        <ul class="text-center center paginate">
                            <li class="nhasanxuat-first"></li>
                            <li class="nhasanxuat-prev"></li>
                            <?php
                            if (isset($_SESSION['get']['NhaSanXuat'])) {
                            ...
                            ?>
                            <li class="nhasanxuat-next"></li>
                            <li class="nhasanxuat-last"></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <script src="/Web2/public/scripts/DoiTacAdmin.js"></script>
    <script>
