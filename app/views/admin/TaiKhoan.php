<link rel="stylesheet" href="/Web2/public/css/admin/TaiKhoanAdmin.css">
            ...
            <div class="taikhoan__row content-row">
                ...
                <div class="title--border">
                    <div class="taikhoan__title row">
                        <div class="center checkbox taikhoan-item-title col-lg-1">
                        ...
                        <h6 class="center taikhoan-item-title col-lg-1">Quyền</h6>
                        <h6 class="center taikhoan-item-title col-lg-2">Tài khoản</h6>
                        <h6 class="center taikhoan-item-title col-lg-2">Mật khẩu</h6>
                        <h6 class="center taikhoan-item-title col-lg-2">Ảnh đại diện</h6>
                        <h6 class="center taikhoan-item-title col-lg-1">Trạng thái bị cấm</h6>
                        <h6 class="center taikhoan-item-title col-lg-1">Đăng nhập</h6>
                        <h6 class="center taikhoan-item-title col-lg-1">Thời gian tạo</h6>
                        <h6 class="center taikhoan-item-title col-lg-1">Thao tác</h6>
                    </div>
                </div>
                    ...
                    if (isset($_SESSION['get']['TaiKhoan'])) {
                        ...
                        for ($i = 0; $i < $length; $i++) {
                            echo '
                                ...
                                <span class="center-left col-lg-1 col-md-4 col-sm-12">' . $TaiKhoan[$i]['quyen']['tenQuyen'] . '</span>
                                <span class="center-left col-lg-2 col-md-1 col-sm-12 row-' . $TaiKhoan[$i]['maTK'] . ' tenTaiKhoan">' . $TaiKhoan[$i]['tenTaiKhoan'] . '</span>
                                <span class="center-left col-lg-2 col-md-2 col-sm-12 row-' . $TaiKhoan[$i]['maTK'] . ' matKhau">' . $TaiKhoan[$i]['matKhau'] . '</span>
                                <div class="center col-lg-2 col-md-2 col-sm-12">
                                    <img class="taikhoan-' . $TaiKhoan[$i]['maTK'] . ' row-' . $TaiKhoan[$i]['maTK'] . ' anhDaiDien" src="' . $TaiKhoan[$i]['anhDaiDien'] . '"></img>
                                </div>
                                <span class="center col-lg-1 col-md-2 col-sm-12 row-' . $TaiKhoan[$i]['maTK'] . ' trangThai">' . $TaiKhoan[$i]['trangThai'] . '</span>
                                <span class="center col-lg-1 col-md-2 col-sm-12 row-' . $TaiKhoan[$i]['maTK'] . ' dangNhap">' . $TaiKhoan[$i]['dangNhap'] . '</span>
                                <span class="center-left col-lg-1 col-md-2 col-sm-12 row-' . $TaiKhoan[$i]['maTK'] . ' thoiGianTao">' . $TaiKhoan[$i]['thoiGianTao'] . '</span>
                                <div class="center col-lg-1 col-md-3 col-sm-12 row-' . $TaiKhoan[$i]['maTK'] . ' ">
                ...
                <div class="content-item__pagination row">
                    <div>
                        <ul class="text-center center paginate">
                            <li class="taikhoan-first"></li>
                            <li class="taikhoan-prev"></li>
                            <?php
                            if (isset($_SESSION['get']['TaiKhoan'])) {
                            ...
                            ?>
                            <li class="taikhoan-next"></li>
                            <li class="taikhoan-last"></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="nhanvien__row content-row">
                <div class="content-item__header">
                    <span>Nhân viên</span>
                    <div>
                        <button class="nhanvien--add "><i class="fas fa-plus"></i></button>
                ...
                <div class="title--border">
                    <div class="nhanvien__title row">
                        <div class="center nhanvien-item-title checkbox col-lg-1">
                        ...
                        <h6 class="center nhanvien-item-title col-lg-1">Tài khoản</h6>
                        <h6 class="center nhanvien-item-title col-lg-1">Họ</h6>
                        <h6 class="center nhanvien-item-title col-lg-1">Tên</h6>
                        <h6 class="center nhanvien-item-title col-lg-2">Ngày sinh</h6>
                        <h6 class="center nhanvien-item-title col-lg-3">Địa chỉ</h6>
                        <h6 class="center nhanvien-item-title col-lg-1">Số điện thoai</h6>
                        <h6 class="center nhanvien-item-title col-lg-1">Lương</h6>
                        <h6 class="center nhanvien-item-title col-lg-1">Thao tác</h6>
                    </div>
                </div>
                    ...
                    if (isset($_SESSION['get']['NhanVien'])) {
                        ...
                        for ($i = 0; $i < $length; $i++) {
                            echo '
                                ...
                                <span class="center-left col-lg-1 col-md-4 col-sm-12">' . $NhanVien[$i]['taikhoan']['tenTaiKhoan'] . '</span>
                                <span class="center-left col-lg-1 col-md-4 col-sm-12 row-' . $NhanVien[$i]['maNV'] . ' ho">' . $NhanVien[$i]['ho'] . '</span>
                                <span class="center-left col-lg-1 col-md-4 col-sm-12 row-' . $NhanVien[$i]['maNV'] . ' ten">' . $NhanVien[$i]['ten'] . '</span>
                                <span class="center col-lg-2 col-md-4 col-sm-12 row-' . $NhanVien[$i]['maNV'] . ' ngaySinh">' . $NhanVien[$i]['ngaySinh'] . '</span>
                                <span class="center-left col-lg-3 col-md-4 col-sm-12 row-' . $NhanVien[$i]['maNV'] . ' diaChi">' . $NhanVien[$i]['diaChi'] . '</span>
                                <span class="center col-lg-1 col-md-4 col-sm-12 row-' . $NhanVien[$i]['maNV'] . ' soDienThoai">' . $NhanVien[$i]['soDienThoai'] . '</span>
                                <span class="center col-lg-1 col-md-4 col-sm-12 row-' . $NhanVien[$i]['maNV'] . ' luong">' . $NhanVien[$i]['luong'] . '</span>
                ...
                <div class="content-item__pagination row">
                    <div>
                        <ul class="text-center center paginate">
                            <li class="nhanvien-first"></li>
                            <li class="nhanvien-prev"></li>
                            <?php
                            if (isset($_SESSION['get']['NhanVien'])) {
                            ...
                            ?>
                            <li class="nhanvien-next"></li>
                            <li class="nhanvien-last"></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="khachhang__row content-row">
                <div class="content-item__header">
                    ...
                    <div>
                        <button class="khachhang--add "><i class="fas fa-plus"></i></button>
                ...
                <div class="title--border">
                    <div class="khachhang__title row">
                        <div class="center khachhang-item-title checkbox col-lg-1">
                        ...
                        <h6 class="center khachhang-item-title col-lg-1">Tài khoản</h6>
                        <h6 class="center khachhang-item-title col-lg-1">Họ</h6>
                        <h6 class="center khachhang-item-title col-lg-1">Tên</h6>
                        <h6 class="center khachhang-item-title col-lg-2">Ngày sinh</h6>
                        <h6 class="center khachhang-item-title col-lg-3">Địa chỉ</h6>
                        <h6 class="center khachhang-item-title col-lg-1">Số điện thoai</h6>
                        <h6 class="center khachhang-item-title col-lg-2">Thao tác</h6>
                    </div>
                </div>
                    ...
                    if (isset($_SESSION['get']['KhachHang'])) {
                        ...
                        for ($i = 0; $i < $length; $i++) {
                            echo '
                                ...
                                <span class="center-left col-lg-1 col-md-4 col-sm-12">' . $KhachHang[$i]['taikhoan']['tenTaiKhoan'] . '</span>
                                <span class="hidden row-' . $KhachHang[$i]['maKH'] . ' maTK">' . $KhachHang[$i]['taikhoan']['maTK'] . '</span>
                                <span class="center-left col-lg-1 col-md-4 col-sm-12 row-' . $KhachHang[$i]['maKH'] . ' ho">' . $KhachHang[$i]['ho'] . '</span>
                                <span class="center-left col-lg-1 col-md-4 col-sm-12 row-' . $KhachHang[$i]['maKH'] . ' ten">' . $KhachHang[$i]['ten'] . '</span>
                                <span class="center col-lg-2 col-md-4 col-sm-12 row-' . $KhachHang[$i]['maKH'] . ' ngaySinh">' . $KhachHang[$i]['ngaySinh'] . '</span>
                                <span class="center-left col-lg-3 col-md-4 col-sm-12 row-' . $KhachHang[$i]['maKH'] . ' diaChi">' . $KhachHang[$i]['diaChi'] . '</span>
                                <span class="center col-lg-1 col-md-4 col-sm-12 row-' . $KhachHang[$i]['maKH'] . ' soDienThoai">' . $KhachHang[$i]['soDienThoai'] . '</span>
                ...
                <div class="content-item__pagination row">
                    <div>
                        <ul class="text-center center paginate">
                            <li class="khachhang-first"></li>
                            <li class="khachhang-prev"></li>
                            <?php
                            if (isset($_SESSION['get']['KhachHang'])) {
                            ...
                            ?>
                            <li class="khachhang-next"></li>
                            <li class="khachhang-last"></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<script src="/Web2/public/scripts/TaiKhoanAdmin.js"></script>
<script>
